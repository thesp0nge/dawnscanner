...
Gem::Specification.new do |gem|
  ...
  gem.description   = %q{Dawn is a security source code scanner for ruby powered code. It is especially designed for web applications, but it works also with general purpose ruby scripts. Codesake::Dawn supports all major MVC frameworks like ruby on rails, padrino and sinatra; it provides more than 180 security checks with their own mitigation suggestion.}
  ...
  gem.post_install_message = "Thank you for installing \"dawnscanner\", a security source code scanner for Ruby. Start securing your code by running \"dawn project_folder\" right now or just run \"dawn --help\" if you want to explore all possible command line flags."
